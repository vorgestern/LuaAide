...
const enum class LuaRotate:int {up5=-5, up4=-4, up3=-3, down3=3, down4=4, down5=5}
    rotate_up5=LuaRotate::up5,
    rotate_up4=LuaRotate::up4,
    rotate_up3=LuaRotate::up3,
    rotate_down3=LuaRotate::down3,
    rotate_down4=LuaRotate::down4,
    rotate_down5=LuaRotate::down5;
